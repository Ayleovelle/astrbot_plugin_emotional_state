...
for (let batch = 1; batch <= maxBatches; batch += 1) {
  ...
  const childEnv = {
    ...
    ASTRBOT_BENCHMARK_RESTORE_CONFIG_EACH_SAMPLE: env("ASTRBOT_BENCHMARK_RESTORE_CONFIG_EACH_SAMPLE", "0"),
    ASTRBOT_EXPECT_PLUGIN: env("ASTRBOT_EXPECT_PLUGIN", "astrbot_plugin_emotional_state"),
    ASTRBOT_EXPECT_PLUGIN_VERSION: env("ASTRBOT_EXPECT_PLUGIN_VERSION", ""),
    ASTRBOT_EXPECT_PLUGIN_DISPLAY_NAME: env("ASTRBOT_EXPECT_PLUGIN_DISPLAY_NAME", ""),
